...
export const getUser = (username) => async (dispatch) => {
  if(username==='invitado'){dispatch(getUserS({name:'Invitado',email:'invitado',rol:'invitado'}))}
  else{
    ...
    headers: { "Access-Control-Allow-Origin": "*" },
      ...
      .then((response) => {console.log(response)
                           if(response.status===204){
                            //usuario no logeado
                            dispatch(getUserS({name:'Invitado',email:'invitado',rol:'invitado'}))
                           }
                            ...
                            .then(json=>
                              ...
                              let user2=json;
                                ...
                                .then(user=> { 
                                 ...
                                 async() => await    fetch("/api/mail/mail/", {
                                      method: "POST",
                                      headers: {
