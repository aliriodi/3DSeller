...
function CardDetail() {
  ...
  //muestra u oculta el boton submit pra que el usuario solo pueda agregar una reseña

  // useEffect(() => {
  //   if (productsDetail.length > 0) {
  //     const resultado = productsDetail.review.some(
  //       (r) => r.user_email === user.email
  //     );
  //     console.log("resñeas", resultado);
  //   } else {
  //     console.log("nada", productsDetail);
  //   }
  ...
  return (
    <>
      ...
      >
        ...
        />
        <p
          className={`error-commentary ${commentaryError ? null : "desactive"}`}
        >
